...
class BlurBackgroundAndTipVC: BoomMenuButtonVC {
    ...
    override func viewDidLoad() {
        ...
        bmb1.blurEffect = UIBlurEffect.init(style: UIBlurEffect.Style.extraLight)
        ...
        bmb2.blurEffect = UIBlurEffect.init(style: UIBlurEffect.Style.dark)
        ...
        bmb3.blurEffect = UIBlurEffect.init(style: UIBlurEffect.Style.light)
